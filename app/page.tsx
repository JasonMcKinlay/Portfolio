  ...
  return (
    <AuroraBackground>
      ...
      <motion.div
        ...
        className="relative w-full min-h-screen flex flex-col justify-between items-center px-4 pt-12 pb-12"
        id="contact-section"
      >
        ...
        <div id="main-contact" className="relative flex flex-col items-center justify-center w-full max-w-6xl px-4 z-10 flex-1 pt-12">
          ...
          <div className="w-3/4 flex flex-col md:flex-row items-center justify-center gap-8 mb-4">
            ...
            <a href="https://www.linkedin.com/in/jason-mckinlay/" target="_blank" className="bg-white/5 hover:bg-white/10 hover:backdrop-blur-md p-6 rounded-xl border border-white/20 hover:border-white/30 hover:scale-105 transition duration-300 shadow-lg shadow-black/20 hover:shadow-slate-600/50 w-full">
              <div className="flex flex-col items-center gap-4">
            ...
            <a href="https://github.com/JasonMcKinlay" target="_blank" className="bg-white/5 hover:bg-white/10 hover:backdrop-blur-md p-6 rounded-xl border border-white/20 hover:border-white/30 hover:scale-105 transition duration-300 shadow-lg shadow-black/20 hover:shadow-slate-600/50 w-full">
              <div className="flex flex-col items-center gap-4">
